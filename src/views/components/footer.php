  ...
  return "
            <footer class='footer'>
              <div class='main-footer'>
                <div class='wide'>
                  <div class='row'>
                    <div class='footer-contact col c-3'>
                      <div class='footer-contact__text'>
                        CĐTH23D - Dự Án Web Bán Giày
                      </div>
                      <div class='footer-contact__info'>
                            <div class='footer-info__name'>0306231291 - Huỳnh Khắc Huy</div>
                      ...
                      <div class='footer-contact__info'>
                            <div class='footer-info__name'>0306231298 - Trần Hoàng Minh Khoa</div>
                            <div class='footer-link flex'>
                                <div class='footer-link__icon'>
                                    <a href='#' target='_blank'>
                                        <img src='../../public/img/facebook_icon.svg'>
              ...
              <div class='sub-footer'>
                <div class='wide'>
                  <div class='row'>
                    <div class='footer-copyright flex-center col c-12'>
                      ©2024 Kickz. All Rights Reserved.
                    </div>
                  </div>
                </div>
              </div>          
