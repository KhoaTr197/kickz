      ...
      <div class='wide'>
        <div class='row'>
          <div class="col c-12 flex-center">
            <form id='importFormAdmin' class="form" action="import_admin.php" method="post" enctype="multipart/form-data">
              <?php 
                echo $error;
              ...
              <div class='form-control-wrap'>
                <div class="form-control">
                  <?php
                    if($_GET['mode'] === 'image') {
                      echo "
                        <div class='form-reminder'>Tải {$formTitles[$_GET['mode']]} (Chỉ hỗ trợ file JPG)</div>
