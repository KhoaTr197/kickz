<?php
  ...
  $header_html = header_render("breadcrumb", false, "../admin/index.php");
  ...
  switch($_GET['mode']) {
    case 'info':
      ...
      $formInputs = [
        "<input class='form-input' type='text' placeholder='Tên Tài Khoản' name='username' value=".$_SESSION['ADMIN']['INFO']['username']." />"
      ];
      $formMode='info';
      break;
    case 'password':
          ...
          <div class='row'>
            <div class="col c-12 flex-center">
              <form class='form' id='edit-form' action='../controllers/editController.php' method='post'>
                ...
                <button class='form-submit-btn btn btn-primary' type='submit' name="mode" value=<?php echo "admin-".$formMode;?> >Xác Nhận</button>
              </form>
            </div>
          </div>
        </div>
